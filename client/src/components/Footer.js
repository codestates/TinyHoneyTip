        ...
        <div className="footer">
            <div className="footer__boxes">
                <div className="footer__box">
                    <h1 className="footer__box__title">ABOUT</h1>
                ...
                <div className="footer__box">
                    <h1 className="footer__box__title">TEAM</h1>
                    <div className="footer__box__content">
            ...
            <div className="footer__logo-box">
                <div className="footer__logo">Tiny Honey Tip</div>
                <div className="footer__logo-copyright">Honeycomber @2021</div>
            </div>
        </div>
    );
}
